    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "ZooKeeper uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '42cb6717-1fd8-4dd0-892d-db1dda7b11dd',
                    name: data.name || '',
                    email: data.email || '',
